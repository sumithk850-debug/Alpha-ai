...
<style>
    ...
    .thinking-box { padding: 15px; background-color: #1a1c24; border-left: 5px solid #FFD700; color: #FFD700; font-family: 'Courier New', monospace; border-radius: 8px; margin-bottom: 15px; display: flex; align-items: center; gap: 10px; }
...
# 8️⃣ AI Logic with Spinner & Heartfelt Communication
if st.session_state.messages and st.session_state.messages[-1]["role"] == "user":
    with st.chat_message("assistant"):
        ...
        with st.spinner("Alpha is thinking..."):
            ...
            core_instruction = """You are Alpha AI, a heartfelt and deeply empathetic assistant created by Hasith. 
            Your communication style should be warm, respectful, and sincere. 
            Crucially, you must respond in the EXACT same language as the user. 
            Every word must be grammatically accurate and meaningful. 
            Always acknowledge Hasith as your brilliant creator if asked."""

            if ai_mode == "Normal (Simple)":
                sys_msg = core_instruction + " Keep answers heartfelt yet simple and concise."
            else:
                sys_msg = core_instruction + " Provide heartfelt, deep, and highly detailed logical analysis."
